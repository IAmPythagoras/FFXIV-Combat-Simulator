...
#Heal GCD
AspectedHelios = AstrologianSpell(3601, True, 1.5, 2.5, 0, 800, empty, [ManaRequirement], type = 1, AOEHeal=True)
AspectedBenefic = AstrologianSpell(3595, True, 0, 2.5, 0, 400, empty, [ManaRequirement], type = 1, TargetHeal=True)
Benefic2 = AstrologianSpell(3610, True, 1.5, 2.5, 0, 700, empty, [ManaRequirement], type = 1, TargetHeal=True)
Benefic = AstrologianSpell(3594, True, 1.5, 2.5, 0, 400, empty, [ManaRequirement], type = 1, TargetHeal=True)
Helios = AstrologianSpell(3600, True, 1.5, 2.5, 0, 700, empty, [ManaRequirement], type = 1, AOEHeal=True)
EssentialDignity = AstrologianSpell(3614, False, 0, 0, 0, 0, ApplyEssentialDignity, [EssentialDignityRequirement], type = 1, TargetHeal=True)
Macrocosmos = AstrologianSpell(25874, True, 0, 0, 250, 600, ApplyMacrocosmos, [MacrocosmosRequirement, ManaRequirement], type = 1)
Microcosmos = AstrologianSpell(17, True, 0, 0, 0, 0, empty, [MicrocosmosRequirement], type = 1, AOEHeal=True)
...
CelestialIntersection = AstrologianSpell(16556, False, 0, 0, 0, 0, ApplyCelestialIntersection, [CelestialIntersectionRequirement], TargetHeal=True)
...
CelestialOpposition = AstrologianSpell(16553, False, 0, 0, 0, 0, ApplyCelestialOpposition, [CelestialOppositionRequirement], AOEHeal=True)
