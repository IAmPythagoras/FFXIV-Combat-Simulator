...
Download this PDF that explains how to use the simulator in its current state : [FFXIV_Combat_Simulator (4).pdf](https://github.com/IAmPythagoras/FFXIVPPSCalculator/files/9596038/FFXIV_Combat_Simulator.4.pdf)
